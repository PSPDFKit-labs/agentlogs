...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style={{ whiteSpace: "nowrap" }}>
        <code>ALLOWED_GITHUB_ORGS</code>
      </td>
      <td style={{ whiteSpace: "nowrap" }}>unset</td>
      <td>
        Optional comma-separated GitHub org allowlist. When set, GitHub sign-in is restricted to members of at least one
        listed org.
      </td>
    </tr>
    <tr>
      <td style={{ whiteSpace: "nowrap" }}>
        <code>AUTO_ADD_TEAM_ID</code>
      </td>
      <td style={{ whiteSpace: "nowrap" }}>unset</td>
      <td>
        Optional team ID to auto-join new users to after signup. If the new user is on the waitlist, AgentLogs also
        promotes them to the <code>user</code> role when adding them to this team.
      </td>
    </tr>
    <tr>
      <td style={{ whiteSpace: "nowrap" }}>
        <code>PUBLIC_SHARING_ENABLED</code>
      </td>
      <td style={{ whiteSpace: "nowrap" }}>
        <code>true</code>
      </td>
      <td>
        Set this to <code>false</code> to disable new public transcript sharing. Users can then only choose
        <code>private</code> or <code>team</code> visibility, and public repos fall back to team or private defaults.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{ whiteSpace: "nowrap" }}>unset</td>
      <td>
        Optional. Restricts GitHub sign-in to members of the listed orgs. Use a comma-separated list like{" "}
        <code>my-org,another-org</code>.
      </td>
    </tr>
  </tbody>
</table>
