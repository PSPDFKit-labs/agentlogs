...
<Note>
  Self-hosted servers can disable public sharing entirely with <code>PUBLIC_SHARING_ENABLED=false</code>. In that mode,
  only <code>private</code> and <code>team</code> visibility are allowed.
</Note>
